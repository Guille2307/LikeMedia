...
La web incluye `/legal/aviso-legal`, `/legal/privacidad`, `/legal/cookies` y `/legal/terminos`, además de un banner de consentimiento con aceptar, rechazar y configurar. El responsable indicado es **Dysmar Vidal · 77461330-K**, `info@likemedia.es`, teléfono `+34 624 62 26 94` y domicilio `Rua Manuel Nuñez 4, bajos, oficina B`. Antes de presentar la web como cumplimiento legal definitivo, conviene confirmar si el domicilio debe incorporar localidad y código postal, y revisar la situación fiscal, retención y plazos de conservación con un profesional. La política no activa analítica ni publicidad actualmente; cualquier herramienta futura deberá integrarse detrás del consentimiento correspondiente.
